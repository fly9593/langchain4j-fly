...
public class LowApiController {
    ...
    // http://localhost:9004/lowapi/api01
    ...
    // http://localhost:9004/lowapi/api03
    @GetMapping(value = "/lowapi/api03")
    public String api03(@RequestParam(value = "prompt", defaultValue = "你是谁") String prompt) {
